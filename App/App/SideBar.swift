...
class SideBar: NSObject, SideBarTableViewControllerDelegate{
    ...
    var originView:UIView! = nil //just in case you need to change this from 'var' back to 'let'
    ...
    init(sourceView:UIView, menuItems:Array<String>){
        ...
        let showGestureRecognicer:UISwipeGestureRecognizer = UISwipeGestureRecognizer(target: self, action: Selector(("handleSwipe:")))
        showGestureRecognicer.direction = UISwipeGestureRecognizerDirection.right
        originView.addGestureRecognizer(showGestureRecognicer)
    ...
    func showSideBar(shouldOpen:Bool){
        ...
        collisionBehavior.addBoundary(withIdentifier: "sidBarBoundary" as NSCopying, from: CGPoint(x: boundaryX, y: 20), to: CGPoint(x: boundaryX, y: originView.frame.size.height))
